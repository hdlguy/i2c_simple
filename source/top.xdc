...
set_property PACKAGE_PIN T10 [get_ports {led_blue}]
set_property PACKAGE_PIN T9  [get_ports {led_green}]
set_property PACKAGE_PIN J5  [get_ports {led_yellow}]
set_property PACKAGE_PIN H5  [get_ports {led_red}]
